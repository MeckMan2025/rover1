...
run_sudo apt install -y ros-jazzy-ublox-dgnss ros-jazzy-ntrip-client python3-smbus2 i2c-tools git python3-colcon-common-extensions ros-jazzy-mavros-msgs ros-jazzy-xacro ros-jazzy-robot-state-publisher ros-jazzy-robot-localization ros-jazzy-sensor-msgs
